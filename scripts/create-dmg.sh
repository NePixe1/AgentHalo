...
dmg_output="$repo_root/outputs/AgentHalo-macOS-1.1.1.dmg"
...
echo "  1. Create a new tag: git tag v1.1.1 && git push origin v1.1.1"
echo "  2. Use GitHub CLI: gh release create v1.1.1 \"$dmg_output\" --title \"Agent Halo v1.1.1\" --notes-file docs/RELEASE_NOTES_1.1.1.md"
